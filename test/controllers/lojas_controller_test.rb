...
class LojasControllerTest < ActionController::TestCase
  ...
  test "should create loja" do
    assert_difference('Loja.count') do
      post :create, loja: { beirro: @loja.beirro, cidade: @loja.cidade, cnpj: @loja.cnpj, enderereco: @loja.enderereco, estado: @loja.estado, nome: @loja.nome, telefone: @loja.telefone }
    end
  ...
  test "should update loja" do
    patch :update, id: @loja, loja: { beirro: @loja.beirro, cidade: @loja.cidade, cnpj: @loja.cnpj, enderereco: @loja.enderereco, estado: @loja.estado, nome: @loja.nome, telefone: @loja.telefone }
    assert_redirected_to loja_path(assigns(:loja))
  end
